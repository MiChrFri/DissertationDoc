...
\hyphenation{Hackystat, human, measuring, several, students}
...
\renewcommand{\thesissupervisor}{Barrett Stephen}      		%% Your thesis supervisor; use mixed-case and don't use any titles or degrees.

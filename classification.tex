...
In this Chapter, the classification of the gathered data is described. That means that the data is interpreted and put into a context which can be used to generate results in the next section.
...
\subsubsection{Detecting the users location}

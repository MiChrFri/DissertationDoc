...
In this scenario I wanted to test the influences of Coffee in the cognitive performance as discovered by Watters, Paul Andrew et. al. \cite{watters1997caffeine}. Simultaneously to their results I used a caffeine level that is almost the value that they found out is the optimum for cognitive performance of 400 mg. 
First, the participant solved the Sudokus without taking any caffeine for more than 16 hours, which is more than enough to make sure no other caffeine intake can influence to experiment \cite{liguori1997absorption}. Additionally the participant had the same breakfast before every experiment. 
For the second part of the experiment, the participant drank a drink that contained hot water with 5 espresso shots from Starbucks. The Coffee Franchise declare the one espresso with 75mg caffeine each which sums our drink up to 375mg. After having the coffee, the participant waited 40 minutes for the caffeine to be absorbed \cite{liguori1997absorption} and started with the Sudoku. 

...
This scenario compares the Sudoku result from before and after running for 30 minutes at a speed of 10 kph in a gym. 10 minutes break are between finishing the run the beginning of solving the Sudoku. The 30 minutes of running a a value determined by testing out the capability of the participant. This duration with that specific speed was very exhausting for the participant during the test. 
